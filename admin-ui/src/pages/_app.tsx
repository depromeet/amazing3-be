...
export default function App({ Component, pageProps: { session, ...pageProps } }: AppProps) {
  ...
  return (
    <>
      <SeoHead />
      <Head>
        <link rel="apple-touch-icon" sizes="180x180" href="/bandiboodi.png" />
        <link rel="icon" type="image/png" sizes="32x32" href="/bandiboodi.png" />
        <link rel="icon" type="image/png" sizes="16x16" href="/bandiboodi.png" />
