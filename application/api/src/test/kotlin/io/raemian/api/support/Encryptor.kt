...
class Encryptor {
     ...
     * ```
     *
     * 2. 환경 변수 JASYPT_ENCRYPTION_PASSWORD에 비밀번호를 대입합니다.
     * 3. password 변수 값에 비밀번호를 대입합니다. (빈으로 관리하고 싶지 않아 자동 주입 넣지 않았습니다.)
     * 4. encrypt 메서드에 ","로 구분해 암호화할 String 값을 넣으세요.
     * 5. ENC() 가 포함된 전체 결과를 기존 값 대신에 대입하세요.
     *
     *
     * @see 주의 : 순수 숫자는 안 됩니다.
     * */
