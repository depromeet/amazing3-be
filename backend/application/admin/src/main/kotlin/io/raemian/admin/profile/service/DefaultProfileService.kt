package io.raemian.admin.profile.service
...
class DefaultProfileService(
    ...
    fun create(
        ...
        return DefaultProfileResult.from(defaultProflie)
    }

    @Transactional(readOnly = true)
    fun findAll(): List<DefaultProfileResult> =
        defaultProfileRepository.findAll().map(::DefaultProfileResult)

    @Transactional(readOnly = true)
    fun find(defaultProfileId: Long): DefaultProfileResult =
        DefaultProfileResult.from(defaultProfileRepository.getById(defaultProfileId))
    ...
    fun update(
        ...
        return DefaultProfileResult.from(defaultProfileRepository.save(defaultProfile))
    }
